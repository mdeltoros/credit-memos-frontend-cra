...
import { ContextMenu, PrimaryButton, CheckCircledIcon, XCircledIcon, PencilIcon, PlusCircledIcon, Modal, Checkbox, AngleIcon, Tooltip } from 'cs-reusable-component-library-exporter';
...
const TableHeaderRow = styled.div`
  ...
  div {
    ...
    &:nth-child(7) {
      visibility: ${ props => Number.isInteger(props.selectedCredit) ? 'hidden' : 'visible'}
    }

    &:nth-child(8) {
      display: ${ props => Number.isInteger(props.selectedCredit) ? 'none' : 'flex'}
    }
  }
